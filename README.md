...
If an algorithm could not be verified, the trace generated by Uppaal can be generated the tool. This can be very useful for troubleshooting the algortihm. 
A single scenario can generated, verified and potential a trace can be generate using:
